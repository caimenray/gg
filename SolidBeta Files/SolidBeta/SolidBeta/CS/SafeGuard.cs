...
namespace SafeGuard
{
        ...
        public static void DiscordLog(string action, string username, string ip, string geolocatedip = "")
        {
            ...
            switch (action)
            {
                case "login":
                    ...
                    actionTitle = "SolidBeta Login";
                    break;
                case "geoip":
                    message = $"{username} Has Just GeoLocated this ip: {geolocatedip} from IP: {ip}!";
                    actionTitle = "SolidBeta GeoIP";
                    break;
                case "memdl":
                    message = $"{username} Has Just Downloaded a Member Tool/File from IP: {ip}!";
                    actionTitle = "SolidBeta Download";
                    break;
                case "mvpdl":
                    message = $"{username} Has Just Downloaded a MVP Tool/File from IP: {ip}!";
                    actionTitle = "SolidBeta Download";
                    break;
                case "register":
                    message = $"{username} Has Registered!";
                    actionTitle = "SolidBeta Registrations";
                    break;
                case "attack":
                    message = $"{username} Has Just Sent An Attack to {ip}!";
                    actionTitle = "SolidBeta Attack";
                    break;
                default:
                    message = $"{username} Has Done Unknown Function";
                    actionTitle = "SolidBeta Unknown";
                    break;
            }
    ...
    {
        internal static string ProgramId = "25b98f7b-c062-4650-ace0-43d48c8cf223";
    }
